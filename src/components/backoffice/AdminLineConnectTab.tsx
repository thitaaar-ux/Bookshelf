      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-neutral-800/80 gap-3">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-1">
            ตั้งค่า LINE Official Account จัดเก็บข้อมูลลงฐานข้อมูล <code className="text-emerald-400 font-mono">{storageType}</code> ถาวร แก้ไขได้ทันทีไม่ต้องรีสตาร์ทเซิร์ฟเวอร์
          </p>
        </div>
